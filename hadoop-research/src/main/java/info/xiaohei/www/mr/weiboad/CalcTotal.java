...
public class CalcTotal {
    ...
    public static void run() throws InterruptedException, IOException, ClassNotFoundException, URISyntaxException {
        ...
        //将hdfs上的文件加入分布式缓存
        job.addCacheFile(new URI("hdfs://localhost:8020/out/8-weiboad/tf-and-n/part-r-00001"));
        job.addCacheFile(new URI("hdfs://localhost:8020/out/8-weiboad/df/part-r-00000"));
